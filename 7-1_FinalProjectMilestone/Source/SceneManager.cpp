...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/gravel.jpg",
		"ground");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/hedge.jpg",
		"lowercenterhedge");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/hedge2.jpg",
		"uppercenterhedge");
...
void SceneManager::SetupSceneLights()
{
	...
	//ambient light to simulate daytime
	...
	//diffuse light to simulate sunshine
	...
	m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", 1.0f, 1.0f, 0.8f);
	m_pShaderManager->setVec3Value("lightSources[1].specularColor", 1.0f, 1.0f, 0.8f);
...
void SceneManager::RenderScene()
{
	...
	/****************************************************************/
	/*** BASE OF CENTER SHRUB									***/

	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(5.0f, 1.5f, 3.0f);
	...
	SetShaderTexture("lowercenterhedge");
	...
	//SetShaderColor(1, 1, 1, 1);
	SetShaderTexture("uppercenterhedge");
	SetShaderMaterial("wood");
	...
	/****************************************************************/
	/***MIDDLE LEFT SHRUB	- SECOND TALL SHRUB FROM FRONT						**/
	...
	/****************************************************************/
	/***FRONT LEFT SHRUB	- FIRST FROM FRONT						**/
	...
	// Set the XYZ position for the mesh
	positionXYZ = glm::vec3(-7.0f, 0.0f, 9.0f);
	...
	/****************************************************************/
	/***MIDDLE LEFT GROUND SHRUB	- LOW BOX BETWEEN FRONT CONES	**/

	// Set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.0f, 3.0f, 4.0f);
	...
	// Set the XYZ position for the mesh
	positionXYZ = glm::vec3(-6.0f, 0.0f, 6.0f);
	...
	/****************************************************************/
	/***FRONT RIGHT SHRUB	- FIRST IN FRONT						**/

	// Set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.0f, 10.0f, 2.0f);
	...
	// Set the XYZ position for the mesh
	positionXYZ = glm::vec3(5.0f, 0.0f, 9.0f);
	...
	/****************************************************************/
	/***MIDDLE RIGHT GROUND SHRUB	- LOW BOX BETWEEN FRONT CONES	**/
	...
	/****************************************************************/
	/***MIDDLE RIGTH SHRUB	- SECOND TALL SHRUB FROM FRONT						**/
